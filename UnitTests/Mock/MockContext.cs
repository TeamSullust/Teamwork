namespace KPCServer.UnitTests
{
    ...
    public class MockContext : IKPCContext
    {
        public int CRCalledTimes;

        public int RRCalledTimes;

        public ReadRecipeOptions options;

        public int RSCalledTimes;

        public RecipeQuery search;
