namespace KitchenPC.DB.Provisioning
{
    ...
    public class DatabaseExporter : IDisposable, IProvisioner
    {
        ...
        {
            var list =
                ImportTableData<Models.IngredientForms, IngredientForms>(
                    r =>
                    new IngredientForms
                        {
        ...
        {
            var list =
                ImportTableData<Models.IngredientMetadata, IngredientMetadata>(
                    r =>
        ...
        {
            var list =
                ImportTableData<Models.Ingredients, Data.DTO.Ingredients>(
                    r =>
                    new Data.DTO.Ingredients
                        {
                            IngredientId = (Guid)r["IngredientId"],
        ...
        {
            var list =
                ImportTableData<Models.NlpAnomalousIngredients, NlpAnomalousIngredients>(
                    r =>
                    new NlpAnomalousIngredients
                        {
        ...
        {
            var list =
                ImportTableData<Models.NlpDefaultPairings, NlpDefaultPairings>(
                    r =>
                    new NlpDefaultPairings
                        {
        ...
        {
            var list =
                ImportTableData<Models.NlpFormSynonyms, NlpFormSynonyms>(
                    r =>
                    new NlpFormSynonyms
                        {
        ...
        {
            var list =
                ImportTableData<Models.NlpIngredientSynonyms, NlpIngredientSynonyms>(
                    r =>
                    new NlpIngredientSynonyms
                        {
        ...
        {
            var list =
                ImportTableData<Models.NlpPrepNotes, NlpPrepNotes>(r => new NlpPrepNotes { Name = r["Name"] as String })
                    .ToArray();
        ...
        {
            var list =
                ImportTableData<Models.NlpUnitSynonyms, NlpUnitSynonyms>(
                    r =>
                    new NlpUnitSynonyms
                        {
        ...
        {
            var list =
                ImportTableData<Models.Recipes, Recipes>(
                    r =>
                    new Data.DTO.Recipes
                        {
        ...
        {
            var list =
                ImportTableData<Models.RecipeMetadata, RecipeMetadata>(
                    r =>
                    new RecipeMetadata
                        {
        ...
        {
            var list =
                ImportTableData<Models.RecipeIngredients, RecipeIngredients>(
                    r =>
        ...
        {
            var list =
                ImportTableData<Models.Favorites, Favorites>(
                    r =>
                    new Favorites
                        {
        ...
        {
            var list =
                ImportTableData<Models.Menus, Menus>(
                    r =>
                    new Data.DTO.Menus
                        {
        ...
        {
            var list =
                ImportTableData<Models.QueuedRecipes, QueuedRecipes>(
                    r =>
                    new QueuedRecipes
                        {
        ...
        {
            var list =
                ImportTableData<Models.RecipeRatings, RecipeRatings>(
                    r =>
                    new RecipeRatings
                        {
        ...
        {
            var list =
                ImportTableData<Models.ShoppingLists, ShoppingLists>(
                    r =>
                    new Data.DTO.ShoppingLists
                        {
        ...
        {
            var list =
                ImportTableData<Models.ShoppingListItems, ShoppingListItems>(
                    r =>
