                    ...
                    var dbRow = new Models.NlpAnomalousIngredients
                                    {
                                        ...
                                        Name = row.Name,
                                        Ingredient =
                                            Models.Ingredients.FromId(row.IngredientId),
                                        WeightForm =
                                            row.WeightFormId.HasValue
                                                ? Models.IngredientForms.FromId(
                                                    row.WeightFormId.Value)
                                                : null,
                                        VolumeForm =
                                            row.VolumeFormId.HasValue
                                                ? Models.IngredientForms.FromId(
                                                    row.VolumeFormId.Value)
                                                : null,
                                        UnitForm =
                                            row.UnitFormId.HasValue
                                                ? Models.IngredientForms.FromId(
                                                    row.UnitFormId.Value)
                                                : null
                                    };
                    ...
                    var dbRow = new Models.RecipeIngredients
                                    {
                                        ...
                                        Ingredient = Models.Ingredients.FromId(row.IngredientId),
                                        IngredientForm =
                                            row.IngredientFormId.HasValue
                                                ? Models.IngredientForms.FromId(
                                                    row.IngredientFormId.Value)
                                                : null,
                                        Unit = row.Unit,
                                        QtyLow = row.QtyLow,
                    ...
                    var dbItem = new Models.ShoppingListItems
                                     {
                                         ...
                                         UserId = row.UserId,
                                         Ingredient =
                                             row.IngredientId.HasValue
                                                 ? Models.Ingredients.FromId(
                                                     row.IngredientId.Value)
                                                 : null,
                                         Recipe =
                                             row.RecipeId.HasValue
                                                 ? Models.Recipes.FromId(row.RecipeId.Value)
                                                 : null,
                                         ShoppingList =
                                             row.ShoppingListId.HasValue
                                                 ? Models.ShoppingLists.FromId(
                                                     row.ShoppingListId.Value)
                                                 : null,
